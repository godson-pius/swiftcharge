...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      <Link
        href={"#"}
        className="text-sm link flex items-center gap-1 text-blue-800"
      >
        Forgot password <IoArrowForward />{" "}
      </Link>

      <button
        type="submit"
        className="w-full btn bg-blue-600 hover:bg-blue-500 text-white my-5"
      >
        Sign in
      </button>
    </form>
