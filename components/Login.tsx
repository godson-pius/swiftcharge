...
const Login = () => {
    ...
    return (
        <form className='w-full lg:w-[30rem] shadow-lg h-max rounded-xl ring-1 ring-gray-300 bg-base-100 p-5 mb-6'
            ...
            <div className="flex flex-col mt-5 mb-2">
                ...
                <input onChange={(e) => inputs.password = e.target.value} type="password" name="password" id="password"
