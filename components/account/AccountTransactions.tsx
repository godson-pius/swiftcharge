    ...
    <>
      <main className='w-full px-5 mt-10'>
        <div className="w-full flex items-center justify-between">
          ...
          <input value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} type="search" name="search" id="search" className='ring-2 ring-gray-200 rounded-lg p-2 px-3 text-sm w-72 outline-none focus:scale-110 duration-700 focus:glass focus:outline-blue-400' placeholder='search for transaction' />
        </div>
