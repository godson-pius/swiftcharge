  ...
  return (
    <main className="w-72 h-screen p-4 pt-5 bg-gradient-to-t from-purple-500 to-blue-500 text-white text-sm fixed">
      ...
      <ul className="mt-16 flex flex-col gap-5">
        ...
        {/*<Link
          href={"#"}
          className={`flex items-center gap-5 rounded-xl hover:shadow-lg hover:p-2 duration-700 ${setActiveMenu("/account/prices")}`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-5 rounded-xl hover:shadow-lg hover:p-2 duration-700 ${setActiveMenu("exit")} bottom-24 absolute`}
        >
        ...
        <Link
          href={"#"}
          className={`flex items-center gap-2 rounded-xl animate-pulse duration-700 ${setActiveMenu("wallet")} bottom-5 absolute text-xs`}
        >
